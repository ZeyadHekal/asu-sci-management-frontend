...
const AssistantMyCoursesView = () => {
  ...
  // TODO: This should be replaced with an API that fetches courses for the current assistant
  // For now, using the general course API but should filter by assistant's courses
  const { 
    data: coursesData, 
    isLoading, 
    error,
...
export default AssistantMyCoursesView; 